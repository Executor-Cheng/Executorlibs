...
{
    public struct TarsHeader
    {
        internal uint _rawTag;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TarsHeader(TarsType type, byte tag)
        {
        ...
        public TarsHeader(uint rawTag)
        {
            _rawTag = rawTag;
        }

        public TarsHeader(ushort rawTag)
        {
            _rawTag = rawTag;
        }

        public TarsType Type
        {
            get => (TarsType)(_rawTag & 0xF);
        ...
        {
            return obj is TarsHeader t && t.Equals(this);
        }

        public bool Equals(TarsHeader t)
        {
            return t._rawTag == this._rawTag;
        }

        public static bool operator ==(TarsHeader left, TarsHeader right)
        {
