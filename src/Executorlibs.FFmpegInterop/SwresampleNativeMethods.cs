...
namespace Executorlibs.FFmpegInterop
{
    ...
    {
        [DllImport("swresample-4.dll", EntryPoint = "swr_alloc", CallingConvention = CallingConvention.StdCall)]
        public static extern void* AllocContext();

        [DllImport("swresample-4.dll", EntryPoint = "swr_alloc_set_opts", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("swresample-4.dll", EntryPoint = "swr_init", CallingConvention = CallingConvention.StdCall)]
        public static extern int InitContext(void* s);

        [DllImport("swresample-4.dll", EntryPoint = "swr_free", CallingConvention = CallingConvention.StdCall)]
