...
{
    /// <summary>
    /// 表示处理B站消息的 <see cref="IMessageParser{JsonElement, TMessage}"/>
    /// </summary>
    /// <typeparam name="TMessage">消息类型</typeparam>
    public interface IBilibiliJsonMessageParser<out TMessage> : IMessageParser<JsonElement, TMessage> where TMessage : IBilibiliJsonMessage
    {

    }

    public abstract class BilibiliJsonMessageParser<TMessage, TMessageImpl> : MessageParser<JsonElement, TMessage>,
