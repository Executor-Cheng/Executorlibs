...
using ISharedFollowMessage = Executorlibs.Shared.Protocol.Models.Danmaku.IFollowMessage;
...
namespace Executorlibs.Bilibili.Protocol.Models.Danmaku
{
    ...
    /// 继承自以下接口:
    /// <list type="number">
    /// <item><see cref="ISharedFollowMessage"/></item>
    /// <item><see cref="IInteractMessage"/></item>
    /// </list>
    /// </remarks>
    [RegisterBilibiliParser(typeof(FollowParser))]
    public interface IFollowMessage : ISharedFollowMessage, IInteractMessage
    {
